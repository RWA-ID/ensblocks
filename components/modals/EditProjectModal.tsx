        ...
        <form onSubmit={save} className="p-6 space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-[#1A1A26] border border-[#2A2A3E] rounded-xl px-4 py-2.5 text-sm text-[#F0F0FF] placeholder-[#8888AA] focus:outline-none focus:border-[#6C63FF] resize-y"
            />
          </div>
